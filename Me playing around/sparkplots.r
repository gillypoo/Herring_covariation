##Spark plot help from Michelle
## May 11, 2017.  
setwd("C:/Users/jagil/Documents/School/699/Herring Data/Source Files")
#source("sparky.r")
##For WASHINGTON data (Spawning stock biomass)
#--------------------------------------------------------------------#
...
head(WAspark2)
##To get rid of the year graph 
WAspark3 <- WAspark2[,-1]
WAspark3
##from sparky.r
sparkWAStats <- t( apply( as.numeric(WAspark3),2,calcStats ) )

plt.spark( x=c(1:nrow(WAspark3)), y=WAspark3, plt.spikes,
